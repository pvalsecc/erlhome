...
%%%
%%% @end
%%% Created : 02. May 2015 14:48
%%%-------------------------------------------------------------------
-module(dispatcher_recorder).
-author("patrick").
...
-spec(handle_cast(Request :: term(), State :: #state{}) ->
    ...
    {noreply, NewState :: #state{}, timeout() | hibernate} |
    {stop, Reason :: term(), NewState :: #state{}}).
handle_cast({handle, Path, Value}, #state{events = Events} = State) ->
    {noreply, State#state{events = [{Path, Value} | Events]}}.
